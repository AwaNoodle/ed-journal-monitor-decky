...
- `src/modules/` — Python backend modules (settings, path_finder, parser, validator, submitter, watcher, diagnostics, activity_log, constants, signal_batcher, session_stats, stream_consumer, ssl_context, edsm_read_client, edsm_system_cache, edsm_worth_scanning, edsm_system_value, edsm_lookup_consumer, forwarders/edsm, forwarders/edsm_client)
